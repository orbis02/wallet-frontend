                        ...
                        <div class="card card-chart">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-category">
                                    <span class="text-success"><i class="fa fa-long-arrow-up"></i> 55% </span> Este mes</p>
                            </div>
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">access_time</i> actualizado en los ultimos 4 minutos
...
<div class="fixed-plugin">
    <div class="dropdown show-dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="button-container">
                <a href="https://www.creative-tim.com/product/material-dashboard-pro" target="_blank" class="btn btn-rose btn-block btn-fill">Hecho con</a>
                    ...
                    <div class="tab-content ">
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-md-4 col-sm-3">
                          <select class="selectpicker" id="userAccountInc" data-size="7" data-style="btn btn-success btn-round" title="Single Select">
                          {{userAccount}}
                          </select>
                        </div>
                       
                        <div class="col-lg-6 col-md-4 col-sm-3">
                          <select class="selectpicker" id="combCategoriesInc" data-size="7" data-style="btn btn-success btn-round" title="Single Select">
                                {{combCategoriesInc}}
                          </select>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                              <input id="amountInc"  name="amountInc" type="number" style="width: 100%;
  height: 100px; font-family: Arial; font-size: 42pt;" class="form-control" placeholder="">
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-md-4 col-sm-3">
                          <select class="selectpicker" id="userAccountBill" data-size="7" data-style="btn btn-success btn-round" title="Single Select">
                                {{userAccount}}
                          </select>
                        </div>
                       
                        <div class="col-lg-6 col-md-4 col-sm-3">
                          <select class="selectpicker" id="combCategoriesBill" data-size="7" data-style="btn btn-success btn-round" title="Single Select">
                            {{combCategoriesBil}}
                          </select>
                        </div>
                      ...
                      <div class="col-sm-10">
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                            <input id="amountBill"  name="amountBill" type="number" style="width: 100%;
  height: 100px; font-family: Arial; font-size: 42pt;" class="form-control" placeholder="">
                            </div>
                          </div>
                ...
                <div class="modal-footer justify-content-center">
                              <button type="button" id="AddRecord"  class="btn btn-success btn-round" data-dismiss="modal">Registrar</button>
                            </div>
